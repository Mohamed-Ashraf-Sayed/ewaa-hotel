...
import {
  ...
  Hotel, CreditCard, Target, CheckSquare, Trophy, CalendarDays, X, BarChart3, Network, MessageCircle, Wallet, Inbox as InboxIcon, BedDouble, Megaphone, Receipt, Shield
} from 'lucide-react';
