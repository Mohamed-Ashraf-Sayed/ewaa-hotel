...
import {
  ...
  Hotel, CreditCard, Target, CheckSquare, Trophy, CalendarDays, X, BarChart3, Network, MessageCircle, Wallet, Inbox as InboxIcon, BedDouble, Megaphone, Receipt, Shield, History
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { to: '/clients', icon: Building2, labelKey: 'nav_clients', roles: ['admin', 'general_manager', 'systems_info', 'vice_gm', 'sales_director', 'assistant_sales', 'sales_rep', 'contract_officer', 'credit_manager', 'credit_officer'] },
  { to: '/contracts', icon: FileText, labelKey: 'nav_contracts', roles: ['admin', 'general_manager', 'systems_info', 'vice_gm', 'sales_director', 'assistant_sales', 'sales_rep', 'contract_officer', 'reservations', 'credit_manager', 'credit_officer'] },
  { to: '/quotes', icon: Receipt, labelKey: 'nav_quotes', roles: ['admin', 'general_manager', 'systems_info', 'vice_gm', 'sales_director', 'assistant_sales', 'sales_rep', 'credit_manager', 'credit_officer', 'reservations'] },
  { to: '/bookings', icon: BedDouble, labelKey: 'nav_bookings', roles: ['admin', 'general_manager', 'systems_info', 'vice_gm', 'reservations', 'sales_director', 'assistant_sales', 'sales_rep', 'contract_officer'] },
  { to: '/visits', icon: MapPin, labelKey: 'nav_visits', roles: ['admin', 'general_manager', 'systems_info', 'vice_gm', 'sales_director', 'assistant_sales', 'sales_rep', 'contract_officer'] },
  { to: '/payments', icon: CreditCard, labelKey: 'nav_payments', roles: ['admin', 'general_manager', 'systems_info', 'vice_gm', 'sales_director', 'assistant_sales', 'sales_rep', 'contract_officer', 'credit_manager', 'credit_officer'] },
  { to: '/credit-payments', icon: Wallet, labelKey: 'nav_credit_payments', roles: ['admin', 'general_manager', 'systems_info', 'vice_gm', 'credit_manager', 'credit_officer'] },
  { to: '/targets', icon: Target, labelKey: 'nav_targets', roles: ['admin', 'general_manager', 'systems_info', 'vice_gm', 'sales_director', 'assistant_sales', 'sales_rep'] },
